  ...
  return (
    <div className="space-y-4">
      {dataSource.includes("simulées") && (
        <div className="bg-yellow-50/30 dark:bg-yellow-900/10 border border-yellow-200/50 dark:border-yellow-800/30 rounded-lg p-2 text-xs text-yellow-700/70 dark:text-yellow-300/70 opacity-80">
      ...
      {dataSource.includes("API") && (
        <div className="bg-green-50/30 dark:bg-green-900/10 border border-green-200/50 dark:border-green-800/30 rounded-lg p-2 text-xs text-green-700/70 dark:text-green-300/70 opacity-80">
